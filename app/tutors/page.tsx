        ...
        <AnimatePresence>
          {allTutors.length > 0 ? (
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="text-center py-16 bg-white rounded-2xl border border-gray-100/80 shadow-md max-w-md mx-auto mb-16"
            >
              <div className="w-16 h-16 bg-blue-50 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
                <FaGraduationCap className="w-8 h-8 text-blue-500" />
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">No Tutors Available</h3>
              <p className="text-gray-600 px-6 text-sm">
                We are currently onboarding new expert tutors. Please check back soon or register as a tutor!
              </p>
            </motion.div>
          )}
        </AnimatePresence>
